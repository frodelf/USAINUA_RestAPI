...
class MainControllerTest {
    ...
    void getAllProducts() {
        ...
        List<Products> products = Arrays.asList(
                new Products(1L,"ball1", 10, "Sport", "http://asdf", "asdgfqweffwedfgs&df"),
                new Products(2L,"ball2", 11, "Another", "http://asdf", "dsdfgsxfhdhgfgh")
                );
        Page<Products> productsPage = new PageImpl<>(products, PageRequest.of(0, 2), products.size());
    ...
    void getAllShops() {
        long id = 1L;
        List<Shops> shops = Arrays.asList(
                new Shops(1L, "Shop1", "image1.png"),
                new Shops(2L, "Shop2", "image2.png")
        );
        Page<Shops> shopsPage = new PageImpl<>(shops, PageRequest.of(0, 2), shops.size());
